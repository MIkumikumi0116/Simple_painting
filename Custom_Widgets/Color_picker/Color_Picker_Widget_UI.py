...
class Ui_Color_Picker_Widget_UI(object):
    def setupUi(self, Color_Picker_Widget_UI):
        ...
        self.Color_Wheel_Button.setCheckable(True)
        self.Color_Wheel_Button.setChecked(True)
        ...
        self.HSV_Button.setChecked(True)
        ...
        self.Display_Button_Layout.setStretch(3, 1)
