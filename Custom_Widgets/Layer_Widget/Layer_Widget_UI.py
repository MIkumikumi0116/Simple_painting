...
class Ui_Layer_Widget_UI(object):
    def setupUi(self, Layer_Widget_UI):
        ...
        self.Button_Layout.addWidget(self.Lock_Button, 2, 1, 1, 1)
        ...
        self.Button_Layout.addWidget(self.Hide_Button, 0, 1, 1, 1)
        self.Move_Up_Button = QtWidgets.QPushButton(Layer_Widget_UI)
        self.Move_Up_Button.setMinimumSize(QtCore.QSize(20, 20))
        self.Move_Up_Button.setMaximumSize(QtCore.QSize(20, 20))
        self.Move_Up_Button.setObjectName("Move_Up_Button")
        self.Button_Layout.addWidget(self.Move_Up_Button, 0, 0, 1, 1)
        self.Move_Down_Button = QtWidgets.QPushButton(Layer_Widget_UI)
        self.Move_Down_Button.setMinimumSize(QtCore.QSize(20, 20))
        self.Move_Down_Button.setMaximumSize(QtCore.QSize(20, 20))
        self.Move_Down_Button.setObjectName("Move_Down_Button")
        self.Button_Layout.addWidget(self.Move_Down_Button, 2, 0, 1, 1)
...
"}")
    ...
    def retranslateUi(self, Layer_Widget_UI):
        ...
        self.Move_Up_Button.setText(_translate("Layer_Widget_UI", "上"))
        self.Move_Down_Button.setText(_translate("Layer_Widget_UI", "下"))
